...
_testAsterisk() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/asterisk.sdp')
      .readAsString();
...
_testNormalSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/normal.sdp').readAsString();
...
_testHackySdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/hacky.sdp').readAsString();
...
_testIceliteSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/icelite.sdp').readAsString();
...
_testInvalidSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/invalid.sdp').readAsString();
...
_testJssipSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/jssip.sdp').readAsString();
...
_testJsepSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/jsep.sdp').readAsString();
...
_testAlacSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/alac.sdp').readAsString();
...
testOnvifSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/onvif.sdp').readAsString();
...
_testSsrcSdp() async {
  String sdp =
      await new File('./lib/src/sdp4/sdp_test_data/ssrc.sdp').readAsString();
...
_testSimulcastSdp() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/simulcast.sdp')
      .readAsString();
...
_testSt2202_6Sdp() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/st2022-6.sdp')
      .readAsString();
...
_testSt2110_20Sdp() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/st2110-20.sdp')
      .readAsString();
...
_testSctpDtls26Sdp() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/sctp-dtls-26.sdp')
      .readAsString();
...
_testExtmapEncryptSdp() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/extmap-encrypt.sdp')
      .readAsString();
...
_testDanteAes67() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/dante-aes67.sdp')
      .readAsString();
...
_testTcpActive() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/tcp-active.sdp')
      .readAsString();
...
_testTcpPassive() async {
  String sdp = await new File('./lib/src/sdp4/sdp_test_data/tcp-passive.sdp')
      .readAsString();
